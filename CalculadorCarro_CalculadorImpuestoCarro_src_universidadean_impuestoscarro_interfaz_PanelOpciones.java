...
public class PanelOpciones extends JPanel implements ActionListener {
     ...
     */
    private final static String VEHICULO_MAS_ANTIGUO = "Más Antiguo";
    ...
    public PanelOpciones(InterfazImpuestosCarro pPrincipal) {
        ...
        btnOpcion1 = new JButton("Más Antiguo");
        btnOpcion1.setActionCommand(VEHICULO_MAS_ANTIGUO);
        btnOpcion1.addActionListener(this);
        add(btnOpcion1);

        btnOpcion2 = new JButton("Precio Promedio");
    ...
    public void actionPerformed(ActionEvent pEvento) {
        ...
        else if (comando.equals(VEHICULO_MAS_ANTIGUO)) {
